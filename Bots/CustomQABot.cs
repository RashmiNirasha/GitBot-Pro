        ...
        protected override async Task OnMembersAddedAsync(IList<ChannelAccount> membersAdded, ITurnContext<IConversationUpdateActivity> turnContext, CancellationToken cancellationToken)
        {
            foreach (var member in membersAdded)
            {
                if (member.Id != turnContext.Activity.Recipient.Id)
                {
                    ...
                    {
                        Title = "Welcome to GitBot-Pro!",
                        Subtitle = "I am a AI bot designed to help you with Git and GitHub",
                        Text = "Ask me anything, and I'll try to find an answer for you.",
                        Images = new List<CardImage> { new CardImage("http://localhost:3978/images/GitBot.png") },
                        Buttons = new List<CardAction>
                        {
                            new CardAction(ActionTypes.OpenUrl, "Learn More", value: "https://example.com/learn-more")
                        }
                    };

                    // Create an attachment with the Hero Card
                    ...
                    // Create a message activity with the attachment and send it
                    var welcomeMessage = MessageFactory.Attachment(attachment);
